    ...
    return (
        type === "sideShow" ? (
            <Card className={`w-full h-full flex flex-col relative`}>
                <div className=" relative h-[calc(100% - 2rem)] w-full bg-slate-300 rounded-md m-4">
                    <Image
                        src={imageUrl}
                        alt={title}
                        layout="fill"
                ...
                <CardContent className="p-4 pl-0 h-full w-full bg-slate-900 flex flex-col">
                    ...
                    <CardFooter className="hidden sm:flex flex-col p-0 pt-4 justify-between w-full gap-4 ">
