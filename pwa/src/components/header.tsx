...
export default function Header() {
    return (
        <>
            <header className="fixed left-0 bg-slate-50 backdrop-blur-md h-20 bg-opacity-90 z-50 top-0 w-screen flex items-center justify-between px-6 py-4 border-b shadow-sm">
