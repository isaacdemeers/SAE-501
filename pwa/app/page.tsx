    ...
    <section className="relative w-full bg-spider-cover">
      ...
      >
        <div className="flex flex-row justify-center items-center translate-x-[5%]">
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            className="w-5 h-5 mx-2 fill-red-500"
          >
      ...
      <div className="container flex flex-row pt-24 pb-8 | md:px-20">
        ...
        <div className="flex flex-1 flex-col items-center text-center | md:text-left md:items-start">
          <h1>
            <span className="block mb-2 text-4xl font-bold text-cyan-200">
              Welcome to
            </span>
            <Image alt="API Platform" src={logo} />
          </h1>
          <p className="my-5 text-lg text-cyan-200">
            This container will host your{" "}
            <a
              className="font-bold text-white hover:bg-cyan-500"
          ...
          <a
            ...
            className="relative px-8 py-3 overflow-hidden text-lg font-extrabold transition-all bg-white text-cyan-700 group hover:pl-4 hover:pr-12"
          >
            Get started
            <div className="absolute top-0 flex items-center justify-center h-full p-1 transition-all left-full w-7 bg-cyan-200 group-hover:-translate-x-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
    ...
    <section className="py-8 bg-white">
      <div className="container | md:px-20">
        <div className="text-center | lg:text-left lg:w-3/5 lg:ml-auto">
          <h2 className="mb-5 font-bold text-black text-md">
            Available services:
          </h2>
